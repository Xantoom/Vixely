	...
	return (
		<div className="flex items-start gap-6 max-w-5xl w-full">
			...
			<div className="flex-1 min-w-0">
				<p className="text-[10px] font-semibold text-text-tertiary uppercase tracking-wider mb-2">Source</p>
				{isGifSource ? (
			...
			{resultUrl && !processing && (
				<div className="flex-1 min-w-0">
					<div className="flex items-center justify-between mb-2">
						<p className="text-[10px] font-semibold text-text-tertiary uppercase tracking-wider">Result</p>
						<span className="text-[10px] font-mono text-success">{formatFileSize(resultSize)}</span>
					</div>
