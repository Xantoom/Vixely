...
export const de: LocaleModule = {
	...
	"audio.segments": "Segmente",
	"audio.split": "Hier trennen",
	"audio.deleteSegment": "Segment löschen",
	"audio.gain": "Verstärkung",
	"audio.fadeIn": "Einblenden",
	"audio.fadeOut": "Ausblenden",
	"audio.equalizer": "Equalizer",
	"audio.normalise": "Lautheit normalisieren",
	"audio.normaliseHint": "Misst das Programm nach EBU R128 und wendet eine einzige Verstärkung an.",
	"audio.targetLoudness": "Ziellautheit",
	"audio.measured": "Gemessen: {value} LUFS",
	"audio.gainLimited": "Verstärkung auf {value} dB begrenzt, um Übersteuerung zu vermeiden.",
