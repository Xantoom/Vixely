...
export const de: LocaleModule = {
	...
	"gif.selectAll": "Alle auswählen",
	"gif.deleteSelected": "Auswahl löschen",
	"gif.reverse": "Reihenfolge umkehren",
	"gif.delay": "Verzögerung",
	"gif.delayAll": "Auf alle Frames anwenden",
	"gif.speed": "Geschwindigkeit",
	"gif.extractFrame": "Diesen Frame speichern",
	"gif.openInImageEditor": "Im Bildeditor öffnen",
	"gif.palette": "Palette",
	"gif.paletteGlobal": "Eine Palette für die ganze Animation",
	"gif.palettePerFrame": "Eine Palette pro Frame",
	"gif.colors": "Farben",
	"gif.dither": "Dithering",
	"gif.dither.none": "Keines",
	"gif.dither.floydSteinberg": "Floyd–Steinberg",
	"gif.dither.bayer": "Geordnet (Bayer)",
	"gif.loop": "Wiederholungen",
	"gif.loopForever": "Endlos",
	"gif.decoding": "Frames werden dekodiert: {count}",
	"gif.noDecoder": "Dieser Browser kann die Frames eines GIF nicht dekodieren.",
	...
	"subtitles.cues": "Untertitelzeilen",
	"subtitles.addCue": "Zeile hinzufügen",
	"subtitles.deleteCue": "Löschen",
	"subtitles.start": "Anfang",
	"subtitles.end": "Ende",
	"subtitles.text": "Text",
	"subtitles.style": "Stil",
	"subtitles.styles": "Stile",
	"subtitles.scriptInfo": "Skript-Kopfdaten",
	"subtitles.shift": "Alle Zeilen verschieben",
	"subtitles.shiftBy": "Um {ms} ms verschieben",
	"subtitles.overlaps": "{count} überlappende Zeilen",
	"subtitles.readingSpeed": "{value} Zeichen pro Sekunde",
	"subtitles.tooFast": "Zu schnell zum bequemen Lesen",
	"subtitles.track": "Spur",
	"subtitles.embedded": "Eingebettet in {name}",
	"subtitles.pgsNotEditable":
		"PGS enthält Bilder, keinen Text: Zeiten und Reihenfolge lassen sich ändern, die Wörter nicht.",
	"subtitles.convertTo": "Umwandeln in",
	"subtitles.willLose": "Die Umwandlung nach {format} verliert:",
	"subtitles.noCues": "Diese Spur enthält keine Zeilen.",
	"subtitles.fontName": "Schrift",
	"subtitles.fontSize": "Größe",
	"subtitles.primaryColour": "Füllung",
	"subtitles.outlineColour": "Kontur",
	"subtitles.bold": "Fett",
	"subtitles.italic": "Kursiv",

	"video.tracks": "Spuren",
	"video.videoTracks": "Video",
	"video.audioTracks": "Audio",
	"video.subtitleTracks": "Untertitel",
	"video.trim": "Schnitt",
	"video.trimStart": "Anfangspunkt",
	"video.trimEnd": "Endpunkt",
	"video.setIn": "Anfangspunkt hier setzen",
	"video.setOut": "Endpunkt hier setzen",
	"video.trimmedDuration": "Behalten: {duration}",
	"video.action.copy": "Kopieren",
	"video.action.reencode": "Neu kodieren",
	"video.action.drop": "Verwerfen",
	"video.subtitleMode": "Untertitel",
	"video.subtitleMode.embed": "In die Datei einbetten",
	"video.subtitleMode.burnIn": "Ins Bild einbrennen",
	"video.subtitleMode.sidecar": "Separat speichern",
	"video.subtitleMode.none": "Weglassen",
	...
	"video.fourKWarning":
		"Bei 4K-Material läuft die Vorschau mit reduzierter Qualität, um flüssig zu bleiben.",
